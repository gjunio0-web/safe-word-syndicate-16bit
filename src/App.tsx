...
export default function App() {
  ...
  return (
    ...
    <div className="relative w-screen h-dvh bg-[#0a0a0a] overflow-hidden font-sans select-none flex flex-col">
      ...
      {/* 1. TITLE SCREEN
        *
        * landscape: this screen had no landscape layout at all before - the
        * portrait stack (header, then a tall centered logo block, then a
        * button column) ran well past 412px of real landscape-phone height,
        * and with the root at overflow-hidden, START BRAWL landed entirely
        * off-screen with no way to scroll to it. overflow-y-auto here is
        * the safety net for that regardless of what else changes; the
        * landscape:flex-row split below is the actual fix, trading the
        * vertical stack for the width landscape has plenty of.
        */}
      {screen === 'TITLE' && (
